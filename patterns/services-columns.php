 ...
 * Slug: ambitious/services-columns
 * Categories: ambitious_services
*/
?>

<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"3.5vw","right":"3.5vw","bottom":"3.5vw","left":"3.5vw"},"blockGap":"3.5vw"}},"backgroundColor":"white","layout":{"contentSize":"1200px","wideSize":"1200px"}} -->
<div class="wp-block-group alignfull has-white-background-color has-background" style="padding-top:3.5vw;padding-right:3.5vw;padding-bottom:3.5vw;padding-left:3.5vw">
	...
	<h2 class="is-style-underlined-heading"><?php _e( 'What we offer', 'ambitious' ); ?></h2>
	<!-- /wp:heading -->
