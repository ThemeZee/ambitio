 ...
 * Slug: ambitious/sidebar-widgets
 * Inserter: no
*/
?>
...
<div class="wp-block-group widget has-border-color has-light-gray-border-color" style="border-style:solid;border-width:1px;padding-top:2.0rem;padding-right:2.0rem;padding-bottom:2.0rem;padding-left:2.0rem">
	...
	<h2 class="is-style-underlined-heading has-large-font-size"><?php _e( 'Categories', 'ambitious' ); ?></h2>
	<!-- /wp:heading -->
...
<div class="wp-block-group widget has-border-color has-light-gray-border-color" style="border-style:solid;border-width:1px;padding-top:2.0rem;padding-right:2.0rem;padding-bottom:2.0rem;padding-left:2.0rem">
	...
	<!-- wp:heading {"className":"is-style-underlined-heading","fontSize":"large"} -->
	<h2 class="is-style-underlined-heading has-large-font-size"><?php _e( 'Archives', 'ambitious' ); ?></h2>
	<!-- /wp:heading -->
...
<div class="wp-block-group widget has-border-color has-light-gray-border-color" style="border-style:solid;border-width:1px;padding-top:2.0rem;padding-right:2.0rem;padding-bottom:2.0rem;padding-left:2.0rem">
	...
	<!-- wp:heading {"className":"is-style-underlined-heading","fontSize":"large"} -->
	<h2 class="is-style-underlined-heading has-large-font-size"><?php _e( 'Tags', 'ambitious' ); ?></h2>
	<!-- /wp:heading -->
